...
class ConsumerMixin(KombuConsumer):
    ...
    def __create_binding(self, headers, routing_key):
        ...
        try:
            channel = self.__ctrl_channel
            B.bind(self.__queue, nowait=True, channel=channel)
    ...
    def __remove_binding(self, binding):
        ...
        try:
            channel = self.__ctrl_channel
            binding.unbind(self.__queue, nowait=True, channel=channel)
        except (AttributeError, NotBoundError):
            pass
...
class PublisherMixin(object):
    ...
    def publish(self, event, headers=None, routing_key=None, payload=None):
        ...
        try:
            ...
            raise
        self.Producer(payload, headers=headers, routing_key=routing_key)
